...
import com.esri.apl.ar_world_positioning.textrecognition.CameraSource;
import com.esri.apl.ar_world_positioning.textrecognition.CameraSourcePreview;
import com.esri.apl.ar_world_positioning.textrecognition.TextRecognitionProcessor;
import com.esri.apl.ar_world_positioning.util.PermissionsUtil;
import com.esri.apl.ar_world_positioning.view.GeoCoordinateSelectionListener;
import com.esri.apl.ar_world_positioning.view.GeoCoordinatesListAdapter;
import com.esri.apl.ar_world_positioning.view.GraphicOverlay;
import com.esri.apl.ar_world_positioning.viewmodel.MainViewModel;
...
//    private float tagDistMeters; // Distance chosen from coordinate text marker tag
    ...
    public void onGeoCoordinateSelected(FoundCoordinate foundCoordinate) {
      ...
      AlertDialog dlg = new AlertDialog.Builder(LivePreviewActivity.this)
...
//              .setMessage("What's your distance and bearing to this text marker?")
    ...
    private DialogInterface.OnClickListener okListener = (dialogInterface, i) -> {
      ...
      // We now have degress *to* the coordinate marker; we want degrees *from* it.
...
//      mainViewModel.setCurrentUserLocation(ptDevice);
      ...
      Intent intent = new Intent(LivePreviewActivity.this, PositionActivity.class);
